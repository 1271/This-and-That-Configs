...
globalkeys = awful.util.table.join(
    ...
    -- Volume
    awful.key({ }, '#121', function () awful.util.spawn("amixer -q sset Speaker toggle -c 1", false) end),
    awful.key({ }, '#122', function () awful.util.spawn("amixer -q sset Speaker 1dB- -c 1", false) end),
    awful.key({ }, '#123', function () awful.util.spawn("amixer -q sset Speaker 1dB+ -c 1", false) end)
)
